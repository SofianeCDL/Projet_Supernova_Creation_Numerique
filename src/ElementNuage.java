...
public class ElementNuage extends PApplet {
    ...
    public ElementNuage(PVector pos, int r, int g, int b) {
        ...
        this.angle = angle + random((float)0,(float)2) * Test.processing.PI;
    ...
    public ElementNuage(PVector pos, int r, int g, int b, float angle) {
        ...
        this.angle = angle + random((float)-0.15,(float) 0.15) * Test.processing.PI % (2*PI);
    ...
    public void drawElement() {
        Test.processing.fill(this.rD, this.gD, this.bD, 150);
        Test.processing.circle(positionOrigine.x, positionOrigine.y, taille);
    }
