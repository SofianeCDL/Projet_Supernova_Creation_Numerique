...
public class ParticuleExplosion extends PApplet {
    ...
    ParticuleExplosion(){
        ...
        this.X         = Test.processing.width/2;
        this.Y         = Test.processing.height/2;
        ...
        this.c1        = Test.processing.color(240, 200, 100); // ambre clair
        this.c2        = Test.processing.color(255, 150, 0); // tangerine clair
        this.c3        = Test.processing.color(187, 11, 11); // cerise
        this.c4        = Test.processing.color(135, 40, 50); //Passe velours
    ...
    public void drawParticule() {
        ...
        Test.processing.fill(this.interpol4Couleurs(x, c1,c2,c3,c4), this.alpha);
        this.alpha -= 0.3;
        Test.processing.circle(position.x, position.y, this.taille);
    ...
    public boolean verificationLimite() {
        return this.position.x < 0 || this.position.x > Test.processing.width || this.position.y < 0 || this.position.y > Test.processing.height;
    }
    ...
    private int interpol2Couleurs(float x, int c1, int c2) {
        int r1 = (int) Test.processing.red(c1);
        int r2 = (int) Test.processing.red(c2);
        int r3 = (int) interpol(x, r1, r2);

        int g1 = (int) Test.processing.green(c1);
        int g2 = (int) Test.processing.green(c2);
        int g3 = (int) interpol(x, g1, g2);

        int b1 = (int) Test.processing.blue(c1);
        int b2 = (int) Test.processing.blue(c2);
