...
public class Menu extends PApplet {
    ...
    public Menu() {
        ...
        this.ecartCentreX               = (Test.processing.width * (float) 12.5) / 100;
        this.ecartCentreY               = (Test.processing.height * 15) / 100;
        this.ecartTexte                 = (Test.processing.height / 2 * 38) / 100;

        this.tailleCadreX               = (Test.processing.width * 90) / 100; //Taille du cadre
        this.tailleCadreY               = (Test.processing.height * 90) / 100;
        ...
        this.centreEcran                = new PVector(Test.processing.width / 2, Test.processing.height / 2); //Centre de l'écran.
        this.centreCadre                = new PVector(Test.processing.width / 2, Test.processing.height / 2); //Centre du cadre du menu.
        ...
        this.taillePolice = (Test.processing.width * 10) / 100;
    ...
    public void drawMenuPrincipal() {
        ...
        Test.processing.noFill();
        Test.processing.strokeWeight(2);
        Test.processing.stroke(255);
        Test.processing.rect(centreCadre.x, centreCadre.y, this.tailleCadreX, this.tailleCadreY);
    ...
    public void drawInformation() {
        ...
        Test.processing.strokeWeight(2);
        Test.processing.stroke(255);
        Test.processing.rect(centreCadre.x, centreCadre.y, this.tailleCadreX, this.tailleCadreY); //Dessin rectangle.
    ...
    public void drawTitre() {
        this.police = Test.processing.createFont("BLADRMF_.TTF", 120); //Police de caractère.
        Test.processing.textFont(police);
        Test.processing.textAlign(CENTER, CENTER);
        Test.processing.textSize(this.taillePolice);
        Test.processing.text("supernova", this.centreEcran.x, this.centreEcran.y - this.ecartTexte); //Ecris Supernova
    }
    ...
    public void tempsLancementSupernova() {
        this.temps = Test.processing.millis();
    }
}