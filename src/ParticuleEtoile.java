...
public class ParticuleEtoile extends PApplet {
    ...
    public ParticuleEtoile(float rayonEtoile, PVector centreEtoile){
        ...
        this.rayonPart    = 2;
        this.dureeVie     = 0;
        this.naissance    = Test.processing.millis();

        //Couleur des particules
        this.c1 = Test.processing.color(25,25,112); //Bleu nuit
        this.c2 = Test.processing.color(70,130,180); //Bleu acier
        this.c3 = Test.processing.color(100,149,237); //Bleu roi
        this.c4 = Test.processing.color(176,196,222); //Bleu acier clair
    ...
    public void drawPart(){
        ...
        Test.processing.circle(this.centrePart.x, this.centrePart.y, this.rayonPart);
    }
    ...
    public void updatePart(){
            ...
            this.dureeVie = Test.processing.millis() - this.naissance;
            this.alpha -= 0.01;
    }
