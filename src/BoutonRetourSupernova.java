...
public class BoutonRetourSupernova extends PApplet implements Boutons {
    //Centre du bouton.
    ...
    public BoutonRetourSupernova(float centreX, float centreY, float gLongeur, float gHauteur) {
    ...
    public void drawBouton() {
        ...
        Test.processing.fill(255,255,255);
        ...
        Test.processing.fill(210,210,210);
        ...
        //Trapèze droite
        Test.processing.beginShape();
        Test.processing.fill(235,235,235);
        Test.processing.vertex(this.gCoinHD.x, this.gCoinHD.y);
        Test.processing.vertex(this.pCoinHD.x, this.pCoinHD.y);
        ...
        //Trapèze bas
        Test.processing.beginShape();
        Test.processing.fill(120,120,102);
        ...
        //Trapèze gauche
        Test.processing.beginShape();
        Test.processing.fill(170,170,170);
        Test.processing.vertex(this.gCoinHG.x, this.gCoinHG.y);
        Test.processing.vertex(this.gCoinBG.x, this.gCoinBG.y);
        Test.processing.vertex(this.pCoinBG.x, this.pCoinBG.y);
        Test.processing.vertex(this.pCoinHG.x, this.pCoinHG.y);
