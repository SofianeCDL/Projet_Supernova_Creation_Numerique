...
public class ArrierePlan extends PApplet {
    ...
    public void drawEtoiles() {
        Test.processing.background(0, 0, 15);
    ...
    public void flash(int temps) {
        if (alpha >=0) {
            Test.processing.fill(255, alpha);
            Test.processing.rect(0,0, Test.processing.width * 2, Test.processing.height * 2);
