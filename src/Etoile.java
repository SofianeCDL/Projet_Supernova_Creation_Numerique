...
public class Etoile extends PApplet {
    ...
    public Etoile(int nb) {
        ...
        //Creation du centre de l'etoile
        this.centreX = Test.processing.width / 2;
        this.centreY = Test.processing.height / 2;
        this.centre = new PVector(centreX, centreY);

        //Element du cercle
        this.rayon = (Test.processing.height * 15) / 100;
        this.nbPoint = nb;
    ...
    public void drawCurve() {
        PVector p, psuiv;
        Test.processing.fill(176,224,200);//bleu poudre
        ...
        for (int i = 0; i < this.nbPoint - 1; ++i) {
            ...
            Test.processing.curveVertex(p.x, p.y);
            Test.processing.curveVertex(psuiv.x, psuiv.y);
        }
