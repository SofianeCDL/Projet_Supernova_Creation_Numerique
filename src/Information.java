...
public class Information extends PApplet {
    ...
    public Information( float cadreX, float cardeY) {
        this.cadreX = cadreX;
        this.cadreY = cardeY;
        this.taillePolice = (float) ((Test.processing.width*1.2) / 100);
    }
    ...
    public void ecritureInformation(int numeroPage) {
        this.police = Test.processing.createFont("nasalization-rg.ttf", this.taillePolice);
        Test.processing.textFont(police);
        Test.processing.textAlign(LEFT, DOWN);
        ...
        if (numeroPage == 1) {
            ...
            Test.processing.text("La plupart des étoiles évoluent dans la séquence principale, ( stade principal de la vie stellaire ). \n" +
            ...
            Test.processing.textSize((float) (this.taillePolice * 1.5));
            Test.processing.text("Fin de vie des étoiles\n", (this.cadreX*12)/100, (this.cadreY*52)/100);

            Test.processing.textSize(this.taillePolice);
            //De même ici, on écrit à partie de 60% de la largeur (pour y ) du cadre.
            Test.processing.text("Les étoiles entre 0,5 et 8 masse solaire ont une fin bien calme. Leur coeur se contracte, leur\n" +
            ...
            Test.processing.textSize(this.taillePolice);
            this.police = Test.processing.createFont("nasalization-rg.ttf", 17);
            Test.processing.text("Les étoiles entre 8 et 25 masses solaires deviennent des supergéantes rouge comme Bételgeuse. \n" +
