    ...
    public void draw() {
        ...
        if (lancementSupernova) { //Démarrage de la supernova.
            ...
            if (menu.lancementBoutonInformation() && menu.getNumeroPageInformation() == 2) {
                ...
                Test.processing.frameRate(3);
                Test.processing.image( this.tabSupernova[frameCount%14], width*74/100,height*39/100,height*30/100,height*20/100);
            }
